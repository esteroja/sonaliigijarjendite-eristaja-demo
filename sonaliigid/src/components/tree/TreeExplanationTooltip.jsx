...
export default function TreeExplanationTooltip({ label, summary }) {
  return (
              ...
              <div className="tooltip-grid">
                <div>
                  <span
                    ...
                    style={{ background: "#fff", marginLeft: 0, marginRight: 8 }}
                  />
                  = statistiliselt ebatüüpiline järjestus.
                </div>

                <div>
                  <strong>p-väärtus</strong> näitab, kui tõenäoline on, et
                  selline erinevus on juhuslik (FDR-korrigeeritud). Mida
                  väiksem on p-väärtus, seda vähem tõenäoline on, et erinevus
                  on juhuslik.
                </div>
                <div>
